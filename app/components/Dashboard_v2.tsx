...
export default function Dashboard() {
  ...
  // Local UI state - default to assistant tab since other tabs are hidden
  ...
  return (
    <div className="min-h-screen bg-gray-100">
        ...
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-6">
              <img
                src="https://get.resova.com/wp-content/uploads/2023/10/resova_logo_main.svg"
                alt="Resova"
                className="h-8"
              />
      ...
      <div className="px-6 py-6">
        {/* Tabs - Hidden, only showing Resova Intelligence */}
          ...
          <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
                ...
                <div className="lg:col-span-2 grid grid-cols-2 gap-4">
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <p className="text-3xl font-bold text-gray-900">{analyticsData.todaysAgenda.bookings}</p>
                  </div>
                  <div className="bg-gray-50 rounded-lg p-4">
                    <p className="text-sm text-gray-600 mb-1">Guests</p>
                    <p className="text-3xl font-bold text-gray-900">{analyticsData.todaysAgenda.guests}</p>
                  </div>
                  <div className="bg-gray-50 rounded-lg p-4">
                    <p className="text-sm text-gray-600 mb-1">First Booking</p>
                    <p className="text-3xl font-bold text-gray-900">{analyticsData.todaysAgenda.firstBooking}</p>
                  </div>
                  <div className="bg-gray-50 rounded-lg p-4">
                    <p className="text-sm text-gray-600 mb-1">Waivers Required</p>
                    <p className="text-3xl font-bold text-gray-900">{analyticsData.todaysAgenda.waiversRequired}</p>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <p className="text-sm text-gray-600">Showing {analyticsData.upcomingBookings.length} bookings for today</p>
              </div>
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
        ...
        {/* Right Columns - Charts and Resova Intelligence */}
...
// Resova Intelligence Card Component - 2-column layout with charts on right
function AIAssistantCard() {
  ...
  const FOCUS_AREAS = {
    overview: {
      ...
      questions: [
        "Provide a concise business overview with key insights",
        "What are the most important trends I should know about?",
        "Summarize my venue's current performance",
      ]
    },
    financial: {
      icon: '💰',
      ...
      questions: [
        "How much revenue did we generate and where is it coming from?",
        "What's our net margin after discounts, refunds, and taxes?",
        "How do our sales compare to the previous period?",
      ]
    },
    operations: {
      icon: '⚙️',
      ...
      questions: [
        "How many bookings do we have today and this week?",
        "How well are we utilizing our capacity across activities?",
        "What are our peak times and when do we have availability?",
      ]
    },
    customers: {
      icon: '👥',
      ...
      questions: [
        "What percentage of sales come from repeat guests?",
        "What's our average revenue per guest and how can we improve it?",
        "Who are our most valuable customers and what do they book?",
      ]
    },
    forecasting: {
      icon: '📈',
      ...
      questions: [
        "How many bookings do we have coming up in the next 7 days?",
        "What's our projected revenue for next month?",
        "Which activities should we staff up for this weekend?",
      ]
    }
  };

  // Auto-generate basic insights when Resova Intelligence tab is first opened
    ...
    <div className="overflow-hidden">
      ...
      <div className="bg-gradient-to-r from-[#2685CF] to-blue-600 text-white px-6 py-5 rounded-t-lg">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h2 className="text-xl font-bold tracking-tight">Resova Intelligence</h2>
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-4" style={{ maxHeight: 'calc(100vh - 400px)' }}>
                ...
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-8 rounded-xl border-2 border-[#2685CF]/20 shadow-sm mb-6">
                  <div className="text-center max-w-2xl mx-auto">
                    ...
                    <p className="text-base text-gray-700 leading-relaxed">
                      Ask me questions about your revenue, bookings, customers, or operations. I'll provide insights based on your real-time data.
                    </p>
                  </div>
                </div>
            ...
            {conversationHistory.map((msg: any, idx: number) => (
              <div key={idx} className={`flex ${msg.role === 'user' ? 'justify-end' : 'justify-start'} animate-fadeIn`}>
                <div className={`max-w-full w-full ${msg.role === 'user' ? 'ml-auto' : 'mr-auto'}`}>
                  <div className={`rounded-lg transition-all duration-200 ${
                    msg.role === 'user'
                      ? 'bg-gradient-to-br from-[#2685CF] to-[#1E6FB0] text-white shadow-sm px-4 py-3'
                      : 'bg-white text-gray-900 border border-gray-200 shadow-sm px-4 py-4'
                  }`}>
                    {msg.role === 'assistant' && (
                      <div className="flex items-center space-x-2 mb-3 pb-2 border-b border-gray-100">
                        <div className="w-5 h-5 rounded-full bg-gradient-to-br from-[#2685CF] to-[#1E6FB0] flex items-center justify-center">
                          <Sparkles className="w-3 h-3 text-white" />
                        </div>
                        <span className="text-xs font-semibold text-gray-600 uppercase tracking-wide">Resova Intelligence</span>
                      </div>
                    )}
                        ...
                        <div className="flex flex-wrap gap-2">
                          {msg.suggestedQuestions.map((question: string, qIdx: number) => (
                            <button
                              key={qIdx}
                              onClick={() => handleSend(question)}
                              className="text-xs bg-blue-50 hover:bg-[#2685CF] hover:text-white text-gray-700 px-2 py-1.5 rounded-md transition-all border border-blue-200 hover:border-[#2685CF]"
                            >
                              {question}
                            </button>
                          ))}
