...
// Suggested questions leveraging new Gift Vouchers, Guests, and Extras Reporting APIs
const SUGGESTED_QUESTIONS = [
  // Revenue & Performance
  "What's my best performing day this week?",
  "Which service should I promote more?",

  // Customer Intelligence (NEW - Guests API)
  "Who are my top 10 highest value customers?",
  "Which VIP customers haven't visited in 30+ days?",

  // Extras Optimization (NEW - Extras API)
  "Which extras are my best sellers?",
  "What extras inventory is running low?",

  // Gift Voucher Intelligence (NEW - Gift Vouchers API)
  "What's my gift voucher redemption rate?",
  "How much unredeemed voucher revenue do I have?",

  // Advanced Cross-Analysis (NEW - Multiple APIs)
  "What's my customer repeat purchase rate?",
  "Which customers should I upsell extras to?",
];
                ...
                <div className="flex-1 bg-white px-5 py-4 rounded-2xl rounded-tl-sm shadow-sm border border-gray-100">
                  <div className="text-sm leading-relaxed text-gray-800 space-y-3">
                    ...
                    <ul className="space-y-1.5 ml-1">
                      ...
                      <li className="flex items-start">
                        <span className="text-[#2685CF] mr-2 mt-0.5">•</span>
                        <span><strong>Understand customer value:</strong> Identify VIPs, repeat buyers, and upsell opportunities</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-[#2685CF] mr-2 mt-0.5">•</span>
                        <span><strong>Maximize extras revenue:</strong> Optimize add-on pricing and inventory levels</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-[#2685CF] mr-2 mt-0.5">•</span>
                        <span><strong>Track gift vouchers:</strong> Monitor redemption rates and unredeemed revenue</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-[#2685CF] mr-2 mt-0.5">•</span>
                    ...
                    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-3 mt-3">
                      ...
                      <p className="text-xs text-gray-600">
                        I can analyze your revenue, capacity, customer lifetime value, gift voucher performance, and extras sales. Ask me anything from "Where are my biggest profit leaks?" to "Which customers should I send promotions to?"
                      </p>
                    </div>
